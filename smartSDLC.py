...
Original file is located at
    https://colab.research.google.com/drive/1wGZLjmy13rKRNqSGprkSGf_nK8kKUuvJ
"""
...
def requirement_analysis(pdf_file, prompt_input):
    ...
    if pdf_file is not None:
        ...
        analysis_prompt = f"Analyze the following requirements and organize them into functional requirements, and technical specification:\n\n{prompt_input}"
        ...
        with gr.Tab("Code Generation"):
            with gr.Row():
                ...
                with gr.Column():
                    ...
                    generated_btn.click(code_generation, inputs=[code_prompt, language_dropdown], outputs=code_output)
